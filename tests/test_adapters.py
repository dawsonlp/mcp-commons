...
from mcp_commons import create_mcp_adapter, validate_use_case_result, UseCaseResult
...
from mcp_commons.exceptions import AdapterError
...
class TestCreateMcpAdapter:
    ...
    async def test_custom_success_handler(self):
        ...
        adapted = create_mcp_adapter(mock_use_case, custom_success_handler=custom_handler)
    ...
    async def test_custom_error_handler(self):
        ...
        adapted = create_mcp_adapter(mock_use_case, custom_error_handler=custom_error_handler)
