...
class MCPConfig:
    ...
    def load_from_file(self, config_file: str) -> None:
        ...
        try:
            ...
            raise ConfigurationError(f"Failed to parse YAML configuration file {config_file}: {e}")
    ...
    def get_section(self, section: str, defaults: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
...
def create_config(
    ...
    env_prefix: str = "MCP",
    required_config: Optional[List[tuple]] = None
) -> MCPConfig:
    """
    ...
    logger.info(f"Configuration initialized (file: {config_file or 'none'}, prefix: {env_prefix})")
    return config
